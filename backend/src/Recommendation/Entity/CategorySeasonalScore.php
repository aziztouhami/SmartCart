...
use App\Recommendation\Repository\CategorySeasonalScoreRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * Learned seasonality index per (category, calendar month), computed
 * offline by App\Recommendation\Command\AnalyzeSeasonalTrendsCommand from
 * historical order volume. 1.0 = average month for that category, >1 =
 * above-average ("in season"), <1 = below-average.
 *
