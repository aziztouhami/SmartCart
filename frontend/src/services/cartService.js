...
export const interactionApi = {
  ...
  track: (productId, type, value = null) => api.post(`/products/${productId}/interact`, { type, value }),
};
...
export const recommendationApi = {
  ...
  forProduct: (productId, limit = 8) => api.get(`/recommendations/product/${productId}`, { params: { limit } }),
};
...
export const reviewApi = {
  list:   (productId, page = 1, limit = 10) => api.get(`/products/${productId}/reviews?page=${page}&limit=${limit}`),
